/* -*- mode: c++; c-basic-offset: 4; indent-tabs-mode: nil -*-
   ...
   $Id: roselements.cpp,v 1.1 2008/02/22 16:48:19 hedayat Exp $
...
void RosElements::SetupMap()
{
    ...
    ROS_DEFINE_ELEMENT(RE_CAPPEDCYLINDER,"CappedCylinder");
    ...
    ROS_DEFINE_ELEMENT(RE_SIMPLECAPPEDCYLINDER,"SimpleCappedCylinder");
