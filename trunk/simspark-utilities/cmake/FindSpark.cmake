...
#  CARBON_LIBRARIES   - List of libraries when using carbon.
#  CARBON_FOUND       - True if carbon found.
...
FIND_LIBRARY(SPARK_LIBRARY NAMES spark
  PATHS ${SPARK_DIR}
  PATH_SUFFIXES simspark lib/simspark)
FIND_LIBRARY(SPARK_DEBUG_LIBRARY NAMES spark_debug
  PATHS ${SPARK_DIR}
  PATH_SUFFIXES simspark lib/simspark)
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(SPARK DEFAULT_MSG SPARK_LIBRARY
         SPARK_INCLUDE_DIR)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(SPARK_DEBUG DEFAULT_MSG SPARK_DEBUG_LIBRARY
         SPARK_INCLUDE_DIR)
...
IF(SPARK_DEBUG_FOUND)
  SET( SPARK_DEBUG_LIBRARIES ${SPARK_DEBUG_LIBRARY} )
ELSE(SPARK_DEBUG_FOUND)
  SET( SPARK_DEBUG_LIBRARIES )
ENDIF(SPARK_DEBUG_FOUND)

MARK_AS_ADVANCED( SPARK_LIBRARY SPARK_DEBUG_LIBRARY SPARK_INCLUDE_DIR )
...
FIND_PATH(CARBON_INCLUDE_DIR carbon/guicontroller.h
  PATHS ${CARBON_DIR}
  PATH_SUFFIXES simspark include/simspark)

SET(CARBON_NAMES spark spark_debug)
...
MARK_AS_ADVANCED( CARBON_LIBRARY CARBON_INCLUDE_DIR )
