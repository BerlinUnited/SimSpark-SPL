...
#include <kerosin/agentaspect/agentaspect.h>
#include <kerosin/agentaspect/visionperceptor.h>
#include <kerosin/agentaspect/forceeffector.h>
#include "linesegmentperceptor.h"

class SurvivalAgentAspect : public kerosin::AgentAspect
{
	//
	// functions
	//
...
private:
	...
	// effectors
	boost::shared_ptr<kerosin::ForceEffector>	mForceEffector;
