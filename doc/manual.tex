%%
%% $Id: manual.tex,v 1.1 2003/11/14 20:56:16 gato_negro Exp $
%%----------------------------------------------------------
...
\title{RoboCup Soccer Server 3D \\
  {\small for Soccer Server 3D Programming Guide Version 1.0 and later}}
\author{
  Christian Bayha,\\
  Markus Gr\"{u}ndler,\\
  Viktor Pautz,\\
...
%%% Programming Environment under Linux, Viktor Pautz
\input{chapter2/chapter2}

%%% Client/Server Protocol, Markus Gründler
\input{chapter3/chapter3}

%%% CPP Unit Test, Sebastian Scholl
\input{chapter4/chapter4}

%%% CVS, Bug Tracking and Coding Standard, Frank Pfaff
\input{chapter5/chapter5}

%%% Documentation with Latex, Christian Bayha
