/* -*- mode: c++; c-basic-offset: 4; indent-tabs-mode: nil -*-
   ...
   $Id: sparkmonitor.h 3 2008-11-21 02:38:08Z hedayat $
...
*/
#ifndef RCCMONITOR_H__
#define RCCMONITOR_H__
...
class RCCMonitor : public oxygen::MonitorSystem
{
public:
    enum ENodeType
        {
    ...
    public:
        ...
        /** the last values of int types sent to the client */
        std::map<std::string, int> ints;
        
        /** the last values of int types sent to the client */
        std::map<std::string, float> floats;
        
        /** the last values of string types sent to the client */
...
protected:
    ...
    */
    ...
    void DescribeAgentState(std::stringstream& ss, NodeCache& entry,
                            boost::shared_ptr<AgentState>);
...
DECLARE_CLASS(RCCMonitor);

#endif // RCCMONITOR_H__
