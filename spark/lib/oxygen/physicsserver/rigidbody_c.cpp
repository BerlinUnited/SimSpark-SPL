...
FUNCTION(RigidBody,setCappedCylinder)
{
    float inDensity;
    float inRadius;
    float inLength;
...
FUNCTION(RigidBody,addCappedCylinder)
{
    float inDensity;
    float inRadius;
    float inLength;
...
FUNCTION(RigidBody,setCappedCylinderTotal)
{
    float inMassTotal;
    float inRadius;
    float inLength;
...
FUNCTION(RigidBody,addCappedCylinderTotal)
{
    float inMassTotal;
    float inRadius;
    float inLength;
