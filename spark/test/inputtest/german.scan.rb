...
if (theInputSystem != nil)
	...
	theInputSystem.addCode (Input.IC_Y, 'y', 'z'[0], 'Z'[0], 0);
	theInputSystem.addCode (Input.IC_Z, 'z', 'y'[0], 'Y'[0], 0);
	# keypad
	...
	theInputSystem.addCode (Input.IC_MINUS, '-', 'ß'[0], '?'[0], '\\'[0]);
	...
	theInputSystem.addCode (Input.IC_LBRACKET, '[', 'ü'[0], 'Ü'[0], 0);
	theInputSystem.addCode (Input.IC_RBRACKET, ']', '+'[0], '*'[0], '~'[0]);
	theInputSystem.addCode (Input.IC_RETURN, 'return', 0, 0, 0);
	
	theInputSystem.addCode (Input.IC_SEMICOLON, ';', 'ö'[0], 'Ö'[0], 0);
	theInputSystem.addCode (Input.IC_APOSTROPHE, '\'', 'ä'[0], 'Ä'[0], 0);
	...
	theInputSystem.addCode (Input.IC_SLASH, '/', '-'[0], '_'[0], 0);
