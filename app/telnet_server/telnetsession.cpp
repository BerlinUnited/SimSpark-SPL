...
TelnetSession::TelnetSession(TelnetDaemon &daemon) : mClientSocket(INVALID_SOCKET), mDaemon(daemon)
{
...
void TelnetSession::Init(SOCKET clientSocket, sockaddr_in clientAddr)
{
